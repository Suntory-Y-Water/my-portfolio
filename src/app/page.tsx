...
export default function Home() {
  const careerData = [
    ...
    },
    {
      ...
      description:
        '椎間板ヘルニアの回復後、友人の紹介で都内のSES企業に就職し、流通業界の会計システムプロジェクトに結合テストから参加。業界未経験ながらExcelとPythonを活用した業務効率化に取り組む。',
    },
    {
      id: '2023-03',
      date: '2023年3月 ~ 2025年3月(予定)',
      description:
        '案件変更を経て、流通業界の店内システムのクラウド移行プロジェクトに参画。大規模開発ながら要件定義から参画し設計や結合テスト、システムテストを経てリリースまでを一貫して経験。',
    },
    {
      id: '2025-04',
      date: '2025年4月(予定) ~ ',
