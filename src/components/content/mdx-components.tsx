...
export const components = {
  ...
  ul: ({ className, ...props }: React.HTMLAttributes<HTMLUListElement>) => (
    <ul
      className={cn('my-6 ml-6 list-disc marker:text-muted-foreground', className)}
      {...props}
    />
  ),
  ol: ({ className, ...props }: React.HTMLAttributes<HTMLOListElement>) => (
    <ol
      className={cn('my-6 ml-6 list-decimal marker:text-muted-foreground', className)}
      {...props}
    />
  ),
  ...
  'pre > code': ({ className, ...props }: React.HTMLAttributes<HTMLElement>) => (
    <code
      className={cn(
