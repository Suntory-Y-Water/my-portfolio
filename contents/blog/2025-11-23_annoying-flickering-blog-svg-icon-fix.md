...
こういった「ちらつき」は、サイトの UX に大きく関わってきます。個人で運営している Web サービスであればまだ許容できるだろうが、実際のプロダクトで頻繁にちらつきが起こると非常に気になるものです。
...
- 埋め込む時は SVG をインライン化することから、XSS のリスクがあるため適切にサニタイズを行いセキュリティリスクを排除する。
